...
import kotlinx.android.synthetic.main.activity_actividad_multiplicar.*
import kotlinx.android.synthetic.main.activity_actividad_multiplicar.valorA
import kotlinx.android.synthetic.main.activity_actividad_multiplicar.valorB


class ActividadMultiplicar : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_actividad_multiplicar)
